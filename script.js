...
// ... (El resto de las definiciones de dados permanece igual)
...
// ✅ OBTENEMOS LOS NUEVOS CONTENEDORES
...
// ✅ FUNCIÓN MODIFICADA PARA DISTRIBUIR LOS DADOS
function popularSeleccionDeDados() {
    // Definimos qué dados pertenecen al grupo de Filosóficos
    ...
    nombresDeDados.forEach((nombre, index) => {
        ...
        // Mantenemos algunos seleccionados por defecto
        if (index < 3) { 
        ...
        // Comprobamos si el dado actual es "Filosófico" y lo añadimos al contenedor correcto
...
botonLanzar.addEventListener('click', function() {
    ...
    // ✅ SELECTOR ACTUALIZADO para que encuentre los checkboxes en AMBOS grupos.
